...
#+begin_src python :results output
  ...
  for mclass, i in meter_class_counter.items():
      if i < MIN_COUNT:
          discarded += 1
          discarded_items += i
          continue
...
#+RESULTS:
: Discarded 181 meter classes as too rare (represent 3405 lines)
: Discarded data represents 0.0011867982031770641 of lines
: Total of 31 meter classes accepted
